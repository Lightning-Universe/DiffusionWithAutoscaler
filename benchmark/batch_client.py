...
def requests_every_6_seconds():
    return [idx for idx in range(0, 120, 6)]


def requests_every_7_seconds():
    # 15 requests per minute
    return [idx for idx in range(0, 61, 7)]
...
if __name__ == "__main__":
    run_benchmark(requests_every_6_seconds())